...
import { LogOut, Plus, BookOpen, FileText, Users, SquarePen, TrendingUp, Clock, Star, Target, Zap, Sparkles, Brain, Coffee, Lightbulb, Rocket, Heart, Globe, Calendar, CheckCircle, BarChart3, Library, MessageCircle, Atom, Settings, Book, Trophy, Swords, StickyNote, Rainbow } from 'lucide-react';
              ...
              >
                {isOwner ? (
                  <>
                    ...
                    >
                      <Link to="/contest-management" className="block group">
                          ...
                          <div className="relative p-8 h-full flex flex-col justify-between">
                            <div>
                              ...
                              <p className="text-sm text-gray-600 leading-relaxed">
                                Create and manage coding contests, track student participation, and view leaderboards.
                              </p>
                            </div>
                    ...
                    <motion.div
                      ...
                      transition={{ duration: 0.8, delay: 1.0, ease: [0.23, 1, 0.32, 1] }}
                    >
                      <Link to="/educator-dashboard" className="block group">
                        <div className="relative h-[280px] rounded-2xl bg-white/80 backdrop-blur-xl border border-black/5 overflow-hidden transition-all duration-700 hover:bg-white/90 hover:border-black/10 hover:shadow-2xl hover:shadow-pink-500/10 hover:-translate-y-1">
                          <div className="absolute inset-0 bg-gradient-to-br from-pink-50/50 to-pink-50/30" />
                          ...
                          <div className="absolute top-8 right-8">
                            <div className="w-14 h-14 rounded-2xl bg-pink-500/10 flex items-center justify-center transition-all duration-500 group-hover:scale-110 group-hover:bg-pink-500/15">
                              <Rainbow className="w-7 h-7 text-pink-600" />
                            </div>
                          </div>

                          <div className="relative p-8 h-full flex flex-col justify-between">
                            <div>
                              <div className="inline-block px-3 py-1 text-xs font-medium text-pink-700 bg-pink-100/60 rounded-full mb-4">
                                EDUCATOR DASHBOARD
                              </div>
                              <h3 className="text-2xl font-light text-gray-900 mb-2 tracking-tight">
                              ...
                              <p className="text-sm text-gray-600 leading-relaxed">
                                Track student progress, view performance metrics, and manage student accounts.
                              </p>
                            </div>
                  ...
                  <>
                    ...
                    <motion.div
                      ...
                      transition={{ duration: 0.8, delay: 1.0, ease: [0.23, 1, 0.32, 1] }}
                    >
                      <Link to="/coding-practice" className="block group">
                        <div className="relative h-[280px] rounded-2xl bg-white/80 backdrop-blur-xl border border-black/5 overflow-hidden transition-all duration-700 hover:bg-white/90 hover:border-black/10 hover:shadow-2xl hover:shadow-fuchsia-500/10 hover:-translate-y-1">
                          <div className="absolute inset-0 bg-gradient-to-br from-fuchsia-100 to-fuchsia-50" />

                          <div className="absolute top-8 right-8">
                            <div className="w-14 h-14 rounded-2xl bg-fuchsia-500/10 flex items-center justify-center transition-all duration-500 group-hover:scale-110 group-hover:bg-violet-500/15">
                              <TbDeviceDesktopCode className="w-7 h-7 text-fuchsia-600" />
                            </div>
                          </div>

                          <div className="relative p-8 h-full flex flex-col justify-between">
                            <div>
                              <div className="inline-block px-3 py-1 text-xs font-medium text-fuchsia-700 bg-fuchsia-100/60 rounded-full mb-4 uppercase">
                                Coding Hub
                              </div>
                              <h3 className="text-2xl font-light text-gray-900 mb-2 tracking-tight">
                                Practice & Learn
                              ...
                              <p className="text-sm text-gray-600 leading-relaxed">
                                Connect LeetCode, Codeforces accounts, track progress, and get AI-powered recommendations to level up your coding skills.
                              </p>
                            </div>

                            <div className="flex items-center text-fuchsia-600 text-sm font-medium mt-4">
                    ...
                    >
                      <Link to="/notes" className="block group">
                        <div className="relative h-[280px] rounded-2xl bg-white/80 backdrop-blur-xl border border-black/5 overflow-hidden transition-all duration-700 hover:bg-white/90 hover:border-black/10 hover:shadow-2xl hover:shadow-amber-500/10 hover:-translate-y-1">
                          ...
                          <div className="relative p-8 h-full flex flex-col justify-between">
                            <div>
                              <div className="inline-block px-3 py-1 text-xs font-medium text-amber-700 bg-amber-100/60 rounded-full mb-4 uppercase">
                                Personal Notes
                              </div>
                              <h3 className="text-2xl font-light text-gray-900 mb-2 tracking-tight">
                                My Notes
                              ...
                              <p className="text-sm text-gray-600 leading-relaxed">
                                Create, organize and manage your notes like Notion. Your personal knowledge base stored locally.
                              </p>
                            </div>
                    ...
                    >
                      <Link to="/attendance" className="block group">
                        <div className="relative h-[280px] rounded-2xl bg-white/80 backdrop-blur-xl border border-black/5 overflow-hidden transition-all duration-700 hover:bg-white/90 hover:border-black/10 hover:shadow-2xl hover:shadow-green-500/10 hover:-translate-y-1">
                          ...
                          <div className="absolute top-8 right-8">
                            <div className="w-14 h-14 rounded-2xl bg-green-500/10 flex items-center justify-center transition-all duration-500 group-hover:scale-110 group-hover:bg-green-500/15">
                              <SquarePen className="w-7 h-7 text-green-600" />
                            </div>
                          </div>
