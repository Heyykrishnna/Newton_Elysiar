  ...
  public: {
    Tables: {
      ...
      coding_contest_participants: {
        ...
        Relationships: [
          {
            foreignKeyName: "coding_contest_participants_contest_id_fkey"
            columns: ["contest_id"]
            isOneToOne: false
      ...
      web_dev_submission_history: {
        ...
        Relationships: [
          {
            foreignKeyName: "web_dev_submission_history_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
    ...
    Enums: {
      achievement_type:
        ...
        | "level_up_10"
        | "level_up_25"
      conversation_type: "educator_student" | "peer_to_peer"
      message_type: "text" | "file" | "image" | "code"
