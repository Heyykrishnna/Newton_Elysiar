    ...
    switch (view.type) {
      ...
      case 'year':
        return (
          <YearView
            {...commonProps}
            onDateClick={(date) => updateView({ type: 'day', current_date: date })}
          />
        );
      default:
  ...
  return (
    <div className="h-screen flex flex-col">
      <CalendarLayout
        ...
        isOwner={isOwner}
        onDateSelect={(date) => updateView({ current_date: date })}
      >
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3 border-t pt-6">
              ...
              <div className="text-sm text-muted-foreground space-y-2">
                ...
                {profile?.role === 'owner' && (
                  <p className="text-primary font-medium">• As an Educator, you can create, edit, and delete all events</p>
                )}
