        ...
        <div className="flex items-start space-x-6">
          <div className="relative">
            <Avatar className="w-24 h-24">
              <AvatarImage src={'https://res.cloudinary.com/dqh5g2nmn/image/upload/v1765284756/__2_uxxhg0.jpg'} />
            </Avatar>
            <input
              type="file"
              ref={fileInputRef}
      ...
      <Card className="p-8 border-0 bg-white/60 backdrop-blur-xl">
        <div className="flex items-center justify-between mb-6">
          ...
          <Button 
            ...
            className="bg-white/80 text-black hover:text-white bg-white hover:bg-black border border-gray-200"
          >
            {isEditing ? (
              <>
      ...
      <Card className="p-8 border-0 bg-white/60 backdrop-blur-xl">
        ...
        <div className="space-y-6">
          <div className="text-center">
            ...
            <p className="text-gray-600 mb-4">Version 4.1.0</p>
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-4">
              ...
              <h1 className="text-xl font-semibold text-gray-900">Profile Control Room</h1>
            </div>
