  ...
  const teamMembers = [
    {
      ...
      role: 'Founder, Developer, Elysiar',
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-12">
            <div className="flex justify-between items-center mb-8">
              ...
              >
                <h2 className="font-medium text-7xl md:text-7xl">
                  Tech Pioneers <br />
                  <span className="text-white/50">building the future</span>
                </h2>
                <p className="mt-6 max-w-xl text-white/70">We bring together brilliant developers, engineers, and tech innovators to create groundbreaking digital solutions.</p>
              </motion.div>
              <a
            ...
            <div className="flex flex-wrap gap-3">
              {filters.map((filter) => (
                <button
                  ...
                  className={`px-5 py-2 rounded-full text-sm font-medium transition-all duration-300 ${selectedFilter === filter.id
